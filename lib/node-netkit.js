...
var nftable = require('../nf/nftable.js');
var nfchain = require('../nf/nfchain.js');
var nfrule = require('../nf/nfrule.js');
...
var boundNfTable = nftable.table;
boundNfTable.bind(this);
var boundNfChain = nfchain.chain;
boundNfChain.bind(this);
var boundNfRule = nfrule.rule;
boundNfRule.bind(this);
...
var nk = {
	...
	nfTable: boundNfTable,
	nfChain: boundNfChain,
	nfRule: boundNfRule,
	nnf: boundNfCommand,
